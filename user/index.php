        ...
        <div class="container">
            <div class="temp-padd">
                ...
                <div class="title-main">
                    <a href="index.html">
                        <h1>UTM India Tender Management System</h1>
                        
                    </a>
                    <marquee>Call for support +91-7982451415</marquee>
                </div>
                <!--title end here-->
                <!--header start here-->
                <div class="header">
                ...
                <!--banner end  <img src="images/tender1090x630.png1" alt="" width="1060px" height="660px"/>here-->
                <br><br>
            </div>
