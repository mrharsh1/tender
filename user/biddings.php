            ...
            <div class="temp-padd">
                ...
                <div class="container d-flex align-items center justify-content-center">
                    <form class="form-horizontal" action="insertIntoTable.php" method="POST">
                        ...
                        <input class="btn btn-block btn-primary" type="submit" value="Submit" name="bid-submit"> 
                        <div class="mb-4"></div>
                    </form>
                </div>
            </div>
...
//        $sql = "INSERT INTO `tender` (`TenderNo`,`Department`, `Description`, `Price`, `DueDate`, `Duration`, `filecontent` ) VALUES ('$TenderNo', '$Dept', '$Desc', '$Price', '$DueDate', '$Duration', '$filename','$filesize','$filecontent')";
    
      $sql = "INSERT INTO `bids` (`TenderID`, `OrgID`, `Charge`, `Months`) VALUES ('$TenderID', '$Orgid', '$charge', '$months ')";  
